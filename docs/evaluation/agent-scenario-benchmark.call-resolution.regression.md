...
生成时间：2026-09-24T14:04:01+08:00。FastAPI Agent API：`http://127.0.0.1:19002`；模型：`qwen2.5-coder:14b`。
...
- Tool Trace：`searchSymbol → findCallers → findCallees → findCallees → findCallees → readFile → readFile → readFile`
...
| 指标 | BEFORE | AFTER |
|---|---:|---:|
| average_tool_steps | 4.88 | 4.75 |
| duplicate_attempts | 0 | 0 |
| no_progress_calls | 7 | 7 |
| executed_no_progress_calls | 7 | 7 |
| max_steps_hits | 0 | 0 |
| complete_observation_checklists | 3 | 4 |
| partial_observation_checklists | 3 | 2 |
...
- Tool Trace：`searchSymbol → findCallees → findCallers → searchSymbol → findCallers → findCallees → readFile → readFile` → `searchSymbol → findCallers → findCallees → findCallees → findCallees`
- 步数：8 → 5；重复调用：0 → 0；无进展：2 → 1。
...
- No-progress / Policy Events：`[{"step": 0, "status": "GRAPH_PATH_FOUND", "message": "Resolved call graph supplied a shortest verified path; no Tool call was fabricated."}, {"step": 2, "status": "NO_NEW_EVIDENCE", "tool": "findCallers", "message": "Tool completed without new Symbols, files, source lines, or resolved edges."}, {"step": 3, "status": "NO_PROGRESS", "tool": "findCallees", "message": "Tool completed without new Symbols, files, source lines, or resolved edges."}, {"step": 4, "status": "NO_PROGRESS", "tool": "findCallees", "message": "Tool completed without new Symbols, files, source lines, or resolved edges."}, {"step": 5, "status": "NO_PROGRESS", "tool": "findCallees", "message": "Tool completed without new Symbols, files, source lines, or resolved edges."}]`
- FinalDiagnosis：`null`
...
- Tool Trace：`searchSymbol → findCallees → findCallees → findCallees → readFile → readFile → readFile → readFile` → `searchSymbol → findCallers → findCallees → findCallees → findCallees → readFile → readFile → readFile`
...
- No-progress / Policy Events：`[{"step": 0, "status": "GRAPH_PATH_FOUND", "message": "Resolved call graph supplied a shortest verified path; no Tool call was fabricated."}, {"step": 3, "status": "NO_NEW_EVIDENCE", "tool": "findCallees", "message": "Tool completed without new Symbols, files, source lines, or resolved edges."}, {"step": 4, "status": "NO_PROGRESS", "tool": "findCallees", "message": "Tool completed without new Symbols, files, source lines, or resolved edges."}, {"step": 5, "status": "NO_PROGRESS", "tool": "findCallees", "message": "Tool completed without new Symbols, files, source lines, or resolved edges."}, {"step": 9, "status": "FINAL_ONLY", "message": "Tool budget exhausted; one final-only model turn, no Tools exposed."}]`
- FinalDiagnosis：`{"issue_type": "CALL_CHAIN_ANALYSIS", "summary": "Traced the call chain from OrderController.createOrder to InventoryRepository.findStock.", "location": {"file": "InventoryRepository.java", "line": 4, "symbol": "demo.order.InventoryRepository.findStock"}, "root_cause": "The call chain from OrderController.createOrder to InventoryRepository.findStock is verified.", "evidence": [{"file": "OrderController.java", "line": 11, "symbol": "demo.order.OrderController.createOrder", "code": "orderService.createOrder()", "reason": "已解析的 CALLS 关系", "kind": "FACT", "source_tool": "call_relation", "source_step": 3}, {"file": "OrderService.java", "line": 11, "symbol": "demo.order.OrderService.createOrder", "code": "inventoryService.checkStock()", "reason": "已解析的 CALLS 关系", "kind": "FACT", "source_tool": "call_relation", "source_step": 4}, {"file": "InventoryService.java", "line": 11, "symbol": "demo.order.InventoryService.checkStock", "code": "inventoryRepository.findStock()", "reason": "已解析的 CALLS 关系", "kind": "FACT", "source_tool": "call_relation", "source_step": 5}], "call_chain": ["OrderController.createOrder", "OrderService.createOrder", "InventoryService.checkStock", "InventoryRepository.findStock"], "fix_suggestion": "", "uncertainty": "None", "root_cause_kind": "INFERENCE"}`
- Unsupported Claims / 校验问题：`["CALL_CHAIN_PROJECTED_FROM_VERIFIED_EDGES", "MODEL_LINE_MISMATCH: 使用 Observation 中的真实位置", "MODEL_SYMBOL_MISMATCH: 使用 Observation 中的 Symbol"]`
- 备注：需核对全部已解析 CALLS 边。
...
- 新 Trace：`searchSymbol → findCallers → findCallees → findCallees → findCallees`
...
- Data-flow Chain Before：`null`
- Data-flow Chain After：`null`
- Canonical Symbols：`[{"raw": "UserService.register", "canonical": "UserService.register", "signature": "register(String email)", "id": "src/UserService.java:5:7:METHOD:UserService.register"}, {"raw": "EmailService.sendEmail", "canonical": "EmailService.sendEmail", "signature": "sendEmail(String email)", "id": "src/EmailService.java:5:8:METHOD:EmailService.sendEmail"}, {"raw": "TemplateService.render", "canonical": "TemplateService.render", "signature": "render()", "id": "src/TemplateService.java:5:8:METHOD:TemplateService.render"}, {"raw": "ConfigRepository.getTemplate", "canonical": "ConfigRepository.getTemplate", "signature": "getTemplate()", "id": "src/ConfigRepository.java:3:5:METHOD:ConfigRepository.getTemplate"}]`
- Verified Call Chain / Projection：`["UserService.register", "EmailService.sendEmail", "TemplateService.render", "ConfigRepository.getTemplate"]` / `null`
- Model Claim：`null`
- System Corrected Result：`null`
- Diagnosis Issues：`["连续工具调用未获得新证据，已提前停止而非耗尽 maxSteps"]`
- FinalDiagnosis：`null`

#### callchain-order-stock · PARTIAL → PARTIAL

- 旧 Trace：`searchSymbol → findCallees → findCallees → findCallees → readFile → readFile → readFile → readFile`
- 新 Trace：`searchSymbol → findCallers → findCallees → findCallees → findCallees → readFile → readFile → readFile`
...
- Verified Evidence After：`[{"file": "OrderController.java", "code": "orderService.createOrder();", "in_trace": true, "in_diagnosis": false}, {"file": "OrderService.java", "code": "inventoryService.checkStock();", "in_trace": true, "in_diagnosis": false}, {"file": "InventoryService.java", "code": "inventoryRepository.findStock();", "in_trace": true, "in_diagnosis": false}]`
- Data-flow Chain Before：`null`
- Data-flow Chain After：`null`
- Canonical Symbols：`[{"raw": "demo.order.OrderController.createOrder", "canonical": "OrderController.createOrder", "signature": "createOrder()", "id": "OrderController.java:10:12:METHOD:demo.order.OrderController.createOrder"}, {"raw": "demo.order.OrderDemoApplication.main", "canonical": "OrderDemoApplication.main", "signature": "main(String[] args)", "id": "OrderDemoApplication.java:4:10:METHOD:demo.order.OrderDemoApplication.main"}, {"raw": "demo.order.OrderService.createOrder", "canonical": "OrderService.createOrder", "signature": "createOrder()", "id": "OrderService.java:10:12:METHOD:demo.order.OrderService.createOrder"}, {"raw": "demo.order.InventoryService.checkStock", "canonical": "InventoryService.checkStock", "signature": "checkStock()", "id": "InventoryService.java:10:15:METHOD:demo.order.InventoryService.checkStock"}, {"raw": "demo.order.InventoryRepository.findStock", "canonical": "InventoryRepository.findStock", "signature": "findStock()", "id": "InventoryRepository.java:4:6:METHOD:demo.order.InventoryRepository.findStock"}]`
...
- Diagnosis Issues：`["CALL_CHAIN_PROJECTED_FROM_VERIFIED_EDGES", "MODEL_LINE_MISMATCH: 使用 Observation 中的真实位置", "MODEL_SYMBOL_MISMATCH: 使用 Observation 中的 Symbol"]`
- FinalDiagnosis：`{"issue_type": "CALL_CHAIN_ANALYSIS", "summary": "Traced the call chain from OrderController.createOrder to InventoryRepository.findStock.", "location": {"file": "InventoryRepository.java", "line": 4, "symbol": "demo.order.InventoryRepository.findStock"}, "root_cause": "The call chain from OrderController.createOrder to InventoryRepository.findStock is verified.", "evidence": [{"file": "OrderController.java", "line": 11, "symbol": "demo.order.OrderController.createOrder", "code": "orderService.createOrder()", "reason": "已解析的 CALLS 关系", "kind": "FACT", "source_tool": "call_relation", "source_step": 3}, {"file": "OrderService.java", "line": 11, "symbol": "demo.order.OrderService.createOrder", "code": "inventoryService.checkStock()", "reason": "已解析的 CALLS 关系", "kind": "FACT", "source_tool": "call_relation", "source_step": 4}, {"file": "InventoryService.java", "line": 11, "symbol": "demo.order.InventoryService.checkStock", "code": "inventoryRepository.findStock()", "reason": "已解析的 CALLS 关系", "kind": "FACT", "source_tool": "call_relation", "source_step": 5}], "call_chain": ["OrderController.createOrder", "OrderService.createOrder", "InventoryService.checkStock", "InventoryRepository.findStock"], "fix_suggestion": "", "uncertainty": "None", "root_cause_kind": "INFERENCE"}`
